...
public class CreateMenuTest extends BaseTestService {
    ...
    public void menuCreate() throws WxErrorException {
        ...
        WxMenuButton sub32Button = new WxMenuButton();
        sub32Button.setName("我的订单");
        sub32Button.setType("view");
        sub32Button.setUrl("http://mkcaffee.chinaeast.cloudapp.chinacloudapi.cn/app/coffees/index.html#/myOrder");
        subThirdButtons.add(sub31Button);
        wxMenuButton3.setSubButtons(subThirdButtons);
