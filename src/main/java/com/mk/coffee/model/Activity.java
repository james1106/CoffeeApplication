...
public class Activity {
     ...
     * @mbg.generated
     */
    public Activity(Integer id, String title, String subTitle, String content, Integer type, Date createDate, Date startTime, Date endTime, String pictureUrl, String enterUrl) {
        this.id = id;
        this.title = title;
