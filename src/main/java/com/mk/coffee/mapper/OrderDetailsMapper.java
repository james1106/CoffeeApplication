...
public interface OrderDetailsMapper {
    ...
    @Insert({
            ...
            "#{bean,jdbcType=SMALLINT}, #{customId,jdbcType=INTEGER}, ",
    ...
    @Select({"select", "id, members_id, money,discount_money, coupon_id, bean, custom_id, notes, create_date, pay_state, ",
            "end_date,total,wx_card_code, order_details", "from order_details", "where members_id = #{memberId} and pay_state=#{payState} ORDER BY create_date DESC"})
    @ResultMap({"com.mk.coffee.mapper.OrderDetailsMapper.ResultMapWithBLOBs"})
