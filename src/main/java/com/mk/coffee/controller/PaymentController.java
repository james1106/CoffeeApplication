package com.mk.coffee.controller;

import com.mk.coffee.service.CoreService;
import com.mk.coffee.service.OrderDetailsService;
import com.mk.coffee.utils.MD5Util;
import com.mk.coffee.utils.Sha1Util;
import com.mk.coffee.utils.XMLUtil;
...
public class PaymentController extends GenericController {
    ...
    private static final String CERTIFICATE_LOCATION = "C:/opt/weixin/apiclient_cert.p12";
    @Autowired
    ...
    private Map<String, String> getReturnMap(CloseableHttpResponse response) throws Exception {
        ...
        if (entity != null) {
            try (BufferedReader bufferedReader = new BufferedReader(new InputStreamReader(entity.getContent(), Charset.forName("UTF-8")))) {
                ...
                returnMap = XMLUtil.parseXmlStringToMap(new String(result.toString().getBytes(Charset.forName("UTF-8")), "UTF-8"));
            }
        }
